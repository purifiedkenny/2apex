...
constexpr long OFFSET_TRAVERSAL_START_TIME = 0x2d3c;          //[RecvTable.DT_LocalPlayerExclusive]->m_traversalStartTime
constexpr long OFFSET_TRAVERSAL_PROGRESS = 0x2d34;            //[RecvTable.DT_LocalPlayerExclusive]->m_traversalProgress
